...
Public Class R_EtiquetaFormula2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_EtiquetaFormula2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_EtiquetaFormula2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_EtiquetaFormula2 = New R_EtiquetaFormula2()
        rpt.Site = Me.Site
        Return rpt
    End Function
