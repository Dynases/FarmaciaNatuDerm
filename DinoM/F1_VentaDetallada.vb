...
Public Class F1_VentaDetallada
...
#Region "Metodos Privados"
    Private Sub _prIniciarTodo()
        Me.Text = "VENTA DETALLADA PARA EXPORTAR"
    ...
    Private Sub _prCargarVenta()
        ...
        Dim dt As DataTable = L_VentasDetallado(fechaDesde, fechaHasta)
        ...
        If dt.Rows.Count > 0 Then
            ...
            With JGrM_Buscador.RootTable.Columns("CodigoVenta")
                .Width = 100
                .Caption = "COD. VENTA"
                .Visible = True
            End With
            With JGrM_Buscador.RootTable.Columns("FechaVenta")
                ...
                .Caption = "FECHA"
            End With
            With JGrM_Buscador.RootTable.Columns("taalm")
                .Visible = False
            End With
            With JGrM_Buscador.RootTable.Columns("Almacen")
                ...
                .Visible = True
            End With
            With JGrM_Buscador.RootTable.Columns("taclpr")
                .Visible = False
            End With
            ...
            With JGrM_Buscador.RootTable.Columns("Nit")
                ...
                .Visible = True
            End With
            With JGrM_Buscador.RootTable.Columns("tatven")
                .Visible = False
            End With
            With JGrM_Buscador.RootTable.Columns("TipoVenta")
                .Width = 100
                .Caption = "TIPO VENTA"
                .Visible = True
            End With
            With JGrM_Buscador.RootTable.Columns("FechaVenc")
                ...
                .Visible = True
            End With
            With JGrM_Buscador.RootTable.Columns("taest")
                .Visible = False
            End With
            With JGrM_Buscador.RootTable.Columns("Observacion")
                ...
                .Visible = True
            End With
            With JGrM_Buscador.RootTable.Columns("taemision")
                .Visible = False
            End With
            ...
            With JGrM_Buscador.RootTable.Columns("NroFacturaRecibo")
                ...
                .Visible = True
            End With
            With JGrM_Buscador.RootTable.Columns("CodProdoOri")
                .Visible = False
            End With
            ...
            With JGrM_Buscador.RootTable.Columns("SubtotalPro")
                .Width = 120
                .Caption = "SUBTOTAL PRO."
                .Visible = True
                .FormatString = "0.00"
                .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            End With
            With JGrM_Buscador.RootTable.Columns("DescuentoPro")
                ...
                .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            End With
            With JGrM_Buscador.RootTable.Columns("TotalPro")
                .Width = 120
                .Caption = "TOTAL PRO"
                .Visible = True
                .FormatString = "0.00"
            ...
            End With
            With JGrM_Buscador.RootTable.Columns("PrecioCostoPro")
                .Width = 100
                .Caption = "P. COSTO"
                .Visible = True
                .FormatString = "0.00"
                .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            End With
            With JGrM_Buscador.RootTable.Columns("PrecioCostoTotal")
                .Width = 120
                .Caption = "P. COSTO TOTAL"
                .Visible = True
                .FormatString = "0.00"
                .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            End With
            With JGrM_Buscador.RootTable.Columns("SubTotalVenta")
                .Width = 120
                ...
                '.AggregateFunction = AggregateFunction.Sum
            End With
            With JGrM_Buscador.RootTable.Columns("DescuentoVenta")
                .Width = 120
                .Caption = "DESCTO. VENTA"
                .Visible = True
                .FormatString = "0.00"
                .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
                '.AggregateFunction = AggregateFunction.Sum
            ...
            With JGrM_Buscador.RootTable.Columns("TotalVenta")
                ...
                '.AggregateFunction = AggregateFunction.Sum
            End With
            With JGrM_Buscador.RootTable.Columns("tafact")
                .Visible = False
            End With
            With JGrM_Buscador.RootTable.Columns("tahact")
                .Visible = False
            End With
            With JGrM_Buscador.RootTable.Columns("tauact")
                .Visible = False
            End With
...
#End Region
    ...
    Public Function P_ExportarExcel(_ruta As String) As Boolean
        ...
        If (1 = 1) Then 'If(_directorio.ShowDialog = Windows.Forms.DialogResult.OK) Then
            ...
            Try
                ...
                Dim _archivo As String = _ubicacion & "\VentaDetallada_" & Now.Date.Day &
    ...
    Private Sub btnExportarExcel_Click(sender As Object, e As EventArgs) Handles btnExportarExcel.Click
        ...
        Dim img As Bitmap = New Bitmap(My.Resources.checked, 50, 50)
        If (P_ExportarExcel(RutaGlobal + "\Reporte\Reporte Ventas")) Then
            ToastNotification.Show(Me, "EXPORTACIÓN DE VENTAS DETALLADAS EXITOSA..!!!",
                                       img, 2000,
                                       eToastGlowColor.Green,
                                       eToastPosition.BottomCenter)
        Else
            ToastNotification.Show(Me, "FALLÓ LA EXPORTACIÓN DE VENTAS DETALLADAS..!!!",
                                       My.Resources.WARNING, 2000,
                                       eToastGlowColor.Red,
                                       eToastPosition.BottomLeft)
        End If
