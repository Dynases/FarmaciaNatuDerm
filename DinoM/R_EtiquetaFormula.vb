...
Public Class R_EtiquetaFormula
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_EtiquetaFormula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_EtiquetaFormula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_EtiquetaFormula = New R_EtiquetaFormula()
        rpt.Site = Me.Site
        Return rpt
    End Function
